...
urlpatterns = [
    ...
    path('show_medicine40/', show_medicine_name2, name='show_medicine_name2'),
    path('show_medicine3/', show_medicine_name3, name='show_medicine_name3'),
    path('show_medicine4/', show_medicine_name4, name='show_medicine_name4'),
